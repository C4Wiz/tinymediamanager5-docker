...
This repository is dedicated to creating a Docker container featuring TinyMediaManager with a GUI interface.

```bash
docker pull c4wiz/tinymediamanager:latest-v5
```
...
For utilizing this build, use `c4wiz/tinymediamanager:latest-v5`.
...
-p 5800:5800 \
-p 5900:5900 \
c4wiz/tinymediamanager:latest-v5
```
